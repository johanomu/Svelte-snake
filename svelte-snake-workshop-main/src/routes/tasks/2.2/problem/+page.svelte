<script>
	import { pickRandomOpenSpace , convertKeyboardKeyToDirection, getNextSnake, DIRECTION_TO_VECTOR} from "$lib/game-helpers.js";
	...
	function onKeyPress(event){
		snake = getNextSnake(snake, DIRECTION_TO_VECTOR[[convertKeyboardKeyToDirection(event.key)]]);
	}
</script>
